        ...
        <div class="flex md:order-2 text-white">
            ...
            <div class="flex pl-4 text-sm">
                @auth
                        ...
                        @endif
                        @can('studentView')
                        <a href="{{ route('student.home.index') }}" class="text-sm text-white hover:text-blue-100 hover:underline">Home</a>
                        @endif
                        @can('svView')
                        <a href="{{ route('supervisors.home.index') }}" class="text-sm text-white hover:text-blue-100 hover:underline">Home</a>
                        @endif
                @else
